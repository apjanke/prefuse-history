    ...
    implements DocumentListener, ActionListener
{
    ...
    private JSlider    commSlider = new JSlider();
    ...
    public SearchPanel(Enronic enronic) {
        searchAttr = EnronicDBLoader.ALL_COLUMNS;
        
        ItemRegistry registry = enronic.getItemRegistry();
        FocusManager fmanager = registry.getFocusManager();
        searcher = (PrefixSearchFocusSet)fmanager.getFocusSet(Enronic.SEARCH_KEY);
        focus = fmanager.getFocusSet(Enronic.CLICK_KEY);
        ...
        commSlider.addChangeListener(new CommunitySliderListener(enronic));
...
//        b.add(queryF);
    ...
    public void setBackground(Color bg) {
        ...
        if ( commSlider != null ) commSlider.setBackground(bg);
    } //
    ...
    public void setForeground(Color fg) {
        ...
        if ( commSlider != null ) commSlider.setForeground(fg);
    } //
